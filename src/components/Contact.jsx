            ...
            <div className="text-left">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    ...
                    <a
                        ...
                        className="flex flex-col items-center justify-center space-y-2 text-slate-300 hover:text-primary transition-colors group bg-slate-800/50 px-4 py-4 rounded-2xl border border-slate-700 hover:border-primary/50"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                        <span className="text-xs font-medium text-center break-all">{resumeData.socials.email.replace('mailto:', '')}</span>
                    </a>
